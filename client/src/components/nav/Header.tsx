...
const DashboardHeader: React.FC = () => { // Fixed `False` to `false`
  ...
  return (
    <header className={`${profile?.isBusinessAccount ? "lg:hidden" : ""} sticky px-5 top-0 flex h-20 w-full border-b bg-white border-gray-200 z-[99998] dark:border-gray-800 dark:bg-gray-900`}>
