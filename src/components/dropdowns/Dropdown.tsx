    ...
    <div className="relative block">
      ...
      >
        <ul className="flex flex-col gap-1 dark:border-gray-800">
          <Link
            to="/authentication"
            className="font-medium text-theme-sm text-white flex bg-brand-500 py-3 w-full rounded-lg justify-center items-center mb-1"
          >
            Get Started
            <Flame className="ml-2 text-white" size={18} />
          </Link>
